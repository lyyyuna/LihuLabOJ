...
answer_problem_list = OJAnswerViewSet.as_view({
    'get' : 'myanswers_forproblem',
})
...
urlpatterns = [
    ...
    url(r'^myanswers', answer_list, name='myanswer_list_api'),
    url(r'^(?P<pk>[0-9]+)/myanswers', answer_problem_list, name='problem_myanswer_list_api'),
